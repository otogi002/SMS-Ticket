...
public class UppsalaFragment extends SherlockFragment implements
	...
	public Bundle getParams() {
		...
		data.putBoolean("price_reduced", ((RadioButton) getActivity()
				.findViewById(R.id.price_reduced)).isChecked());
	...
	public void onResume() {
		...
		SharedPreferences prefs = getActivity().getSharedPreferences(mSharedPrefs, Context.MODE_PRIVATE);
		
		if (prefs.getBoolean("price_reduced", false)) {
			((RadioButton) getView().findViewById(R.id.price_reduced)).setChecked(true);
		}
	}
	...
	public void onPause() {
		...
		Editor editor = getActivity().getSharedPreferences(mSharedPrefs, Context.MODE_PRIVATE).edit();
